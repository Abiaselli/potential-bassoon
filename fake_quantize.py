    ...
    def forward(self, X):
        if self.observer_enabled[0] == 1:
            ...
            try:
                ...
                # Reset min_val and max_val for observer
                self.activation_post_process.min_val.fill_(0.0)
                self.activation_post_process.max_val.fill_(1.0)
                _scale, _zero_point = self.calculate_qparams()

            print(f"Observer Min: {self.activation_post_process.min_val}, Max: {self.activation_post_process.max_val}")
